...
<title>海洋博客club管理后台登陆</title>
<%-- <script
	src="${pageContext.request.contextPath}/static/jquery-3.3.1.min/jquery-3.3.1.min.js"></script> --%>
...
<body>
		...
		<DIV
			...
			<P style="position: relative;">
				<SPAN class="p_logo"></SPAN> <INPUT id="password" name="password"
					...
					<%-- value="${blogger.password }" --%> value="xiehaiyang">
			</P>
	...
	<div style="text-align: center; padding-top: 30px;color: blue;" >Copyright ©2018@xiehaiyang.club</div>
</body>
</html>