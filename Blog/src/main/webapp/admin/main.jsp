...
<title>海洋博客club后台</title>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/jquery-easyui-1.5.5.2/themes/default/easyui.css">
		...
		<tr>
			<td width="50%">
				<img alt="logo" style="height: 50px;"
					src="${pageContext.request.contextPath}/static/images/haiyang.png">
				</td>
			<td valign="middle" align="right" width="50%">
				<font  size="3" style="color: blue;">&nbsp;&nbsp;<strong>欢迎：</strong>
				</font>
				<font style="color: blue;">${currentUser.userName }&nbsp;&nbsp;&nbsp;&nbsp;
				</font>
			</td>
		</tr>
	</table>
...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px"><font  style="color: blue;" size="10">海洋博客club后台管理系统</font></div>
		</div>
	</div>
</div>
...
<div region="south" style="height: 25px;padding: 5px" align="center">
	<font style="color: blue">Copyright ©2018@www.xiehaiyang.club</font>
</div>
