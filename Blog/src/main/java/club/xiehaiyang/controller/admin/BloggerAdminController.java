package club.xiehaiyang.controller.admin;
...
import  club.xiehaiyang.util.DateUtil;
import  club.xiehaiyang.util.ResponseUtil;
...
public class BloggerAdminController {
	...
	public String modifyPassword(String newPassword,HttpServletResponse response)throws Exception{
		...
		blogger.setPassword(CryptographyUtil.md5(newPassword, "xiehaiyang"));
		int resultTotal=bloggerService.update(blogger);
